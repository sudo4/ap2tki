...
<body class="fix-header card-no-border">
    ...
    <!-- ============================================================== -->
    <section id="wrapper" class="error-page" style="background-image:url(/dashboard/assets/images/background/error-bg.jpg);">
        <div class="error-box">
            <div class="error-body text-center">
                <h1>@yield('code')</h1>
                <h3 class="text-uppercase"> @yield('message')</h3>
                <p class="text-muted m-t-30 m-b-30">Keliatannya Kamu Nyasar</p>
                <a href="/" class="btn btn-info btn-rounded  m-b-40">Back to home</a> 
            </div>
            <footer class="footer text-center">© 2020 AP2TKI.</footer>
        </div>
    </section>
    <!-- ============================================================== -->
    <!-- End Wrapper -->
